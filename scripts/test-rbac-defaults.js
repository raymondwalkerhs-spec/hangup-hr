...
const CHECKS = [
  ...
  ["viewSalesThisMonth", (ur) => roles.canViewSalesThisMonth(ur)],
  ["viewSalesLogFilters", (ur) => roles.canViewSalesLogFilters(ur)],
  ["viewSalesRankings", (ur) => roles.canViewSalesRankings(ur)],
  ["settingsThemeUnlocks", (ur) => roles.canSettingsThemeUnlocks(ur)],
  ...
  ["viewRpmWeeklyDashboard", (ur) => roles.canViewRpmWeeklyDashboard(ur)],
  ["editRpmWeeklyTargets", (ur) => roles.canEditRpmWeeklyTargets(ur)],
