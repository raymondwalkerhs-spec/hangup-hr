...
module.exports = {
  ...
  // Dual-run / MFA / Google bridge (AUTH_BACKEND feature flag)
  getAuthBackendMode: authBridge.getAuthBackendMode,
  isAuthBridgeEnabled: authBridge.isAuthBridgeEnabled,
  syncPasswordToAuth: authBridge.syncPasswordToAuth,
  setupNeeds: authBridge.setupNeeds,
  fetchAppUserAuthRow: authBridge.fetchAppUserAuthRow,
  authBridge,
};
