...
const INTERNAL_FEEDBACK_PROCESSED = "Processed";
const INTERNAL_FEEDBACK_PENDING = "Pending process";
...
function applyQualityDefaults(formData = {}) {
  ...
  if (!fd.internalFeedback) fd.internalFeedback = INTERNAL_FEEDBACK_PENDING;
  return fd;
}
...
module.exports = {
  ...
  CLIENT_CALLBACK,
  CLIENT_RETRANSFER,
  INTERNAL_FEEDBACK_PROCESSED,
  INTERNAL_FEEDBACK_PENDING,
