...
const FIELDS = [
  ...
  },
  {
    ...
    type: "date",
    sensitive: false,
    viewRoles: [...QUALITY_ROLES, ...ADMIN_RTM_VIEW, "hr"],
    editRoles: [...ADMIN_ONLY, "quality", "rtm"],
  },
  {
    key: "routingNumber",
  ...
  { key: "price", label: "Price ($)", section: "lead", type: "number", hideOnCreate: true, hideOnEdit: true, viewRoles: QUALITY_ROLES },
  {
    key: "priceTier",
    label: "Price Tier",
    section: "lead",
    ...
    editRoles: [],
    qualityView: true,
    // Allow on quality ticket surface (not main edit)
    hideOnQualityEdit: false,
  },
...
const ATTACHMENT_KINDS = [
  { key: "recording", label: "Recordings", viewRoles: ["quality", "rtm", "admin", "hr", "finance", "ceo"], editRoles: ["admin", "hr", "quality", "rtm"] },
