...
const ADMIN_ONLY = ["admin", "hr", "finance", "ceo"];
const QUALITY_ROLES = ["quality", "rtm", "admin", "hr", "finance", "ceo"];
...
const FIELDS = [
  ...
  { key: "reviewer", label: "Reviewer", section: "quality", type: "employee", employeeFilter: "quality", viewRoles: QUALITY_ROLES, editRoles: QUALITY_ROLES },
  ...
  { key: "assignVerifier", label: "Assign Verifier", section: "quality", type: "employee", employeeFilter: "quality", viewRoles: QUALITY_ROLES, editRoles: QUALITY_ROLES },
...
const ATTACHMENT_KINDS = [
  { key: "recording", label: "Recordings", viewRoles: DEFAULT_VIEW, editRoles: ["agent", "tl", "op", "admin", "hr"] },
  ...
  { key: "confirmation", label: "Confirmation", viewRoles: DEFAULT_VIEW, editRoles: ["agent", "tl", "op", "admin", "hr"] },
];
...
function listFieldsForRole(role, permissionsMap = {}) {
  return FIELDS.filter((f) => canViewField(f, role, permissionsMap[f.key]));
}
