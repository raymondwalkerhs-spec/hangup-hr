const SPLIT_KINDS = ["payment", "training_bonus", "correction"];
...
function validateSplit(split, payslipContext = null) {
  ...
  if ((kind === "payment" || kind === "training_bonus") && !(amount > 0)) {
    return `${kind === "training_bonus" ? "Training bonus" : "Payment"} split amount must be greater than 0`;
  }
