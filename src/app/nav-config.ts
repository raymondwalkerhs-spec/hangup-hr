...
export const NAV_ITEMS: NavItem[] = [
  ...
  { path: "/cats", page: "cats", label: "Cats", icon: "cat", group: "Overview", navId: "nav-cats" },
  { path: "/team-dashboard", page: "team-dashboard", label: "Team dashboards", icon: "bar-chart", group: "Overview", navId: "nav-team-dashboard" },
  { path: "/q-feedback", page: "q-feedback", label: "Q Feedback", icon: "message-square", group: "Overview", navId: "nav-q-feedback" },
  ...
  { path: "/attendance", page: "attendance", label: "Attendance", icon: "calendar-check", group: "Time & Attendance", navId: "nav-attendance" },
  { path: "/breaks", page: "breaks", label: "Breaks", icon: "coffee", group: "Time & Attendance", navId: "nav-breaks" },
  { path: "/requests", page: "requests", label: "Requests", icon: "file-text", group: "Time & Attendance", navId: "nav-requests" },
  ...
  { path: "/payroll", page: "payroll", label: "Payroll", icon: "wallet", group: "Compensation", navId: "nav-payroll" },
  { path: "/salaries", page: "salaries", label: "Salaries", icon: "banknote", group: "Compensation" },
  { path: "/bonuses", page: "bonuses", label: "Bonuses", icon: "gift", group: "Compensation", navId: "nav-bonuses" },
  { path: "/deductions", page: "deductions", label: "Deductions", icon: "minus-circle", group: "Compensation", navId: "nav-deductions" },
  ...
  { path: "/recycle", page: "recycle", label: "Recycle bin", icon: "trash-2", group: "Administration", navId: "nav-recycle" },
