...
- **Current version:** `1.5.1` (`package.json` → `version`)
- **Previous:** `1.5.0` (training payroll), `1.4.6` (sales filter hotfix), `1.4.5` (reposition / web installer / release CI), `1.4.1` (sales columns/filters/permissions pages), `1.4.0` (sales log overhaul)
...
|---------|------------|-------|
| **1.5.1** | **true** | Payroll page fix when trainees have training programs (actionPlans in batch enrich) |
